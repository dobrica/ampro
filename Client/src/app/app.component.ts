...
export class AppComponent {
  ...
  timeout: any = null;
  numberOfChars = 150;
  templatesServiceBaseUrl = "http://localhost:3000/templates";
  messagesServiceBaseUrl = "http://localhost:3000/messages";
  textStatisticsServiceBaseUrl = "http://localhost:3000/statistics";
  getAllTemplatesEndpoint = "/api/getall";
  getMessageStatsEndpoint = "/api/message/stats";
  addNewMessageEndpoint = "/api/add";
  wordsCount: number = 0;
